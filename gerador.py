...
class GeradorReal:
    def __init__(self, site_url="https://healthandlongevity.reviewnexus.blog"):
    ...
    def carregar_config(self):
        ...
        config = {
            "site": {
                ...
                "language": "pt-BR",
                "author": "Equipe Health and Longevity",
                "twitter": "@healthandlongevity",
                "google_analytics": "",
...
"""
    ...
    def criar_templates_basicos(self):
        ...
        if not css_path.exists():
            css = '''/* CSS Básico - Health and Longevity v6.0 */
...
<div class="widget">
    ...
    <div class="container">
        <div class="logo">
            <a href="../index.html">🔥 Health and Longevity</a>
        </div>
        <nav class="main-nav">
    ...
    <div class="container">
        ...
        <p class="copyright">&copy; {datetime.now().year} Health and Longevity. Todos os direitos reservados.</p>
    </div>
</footer>'''
...
<head>
    ...
    <script src="https://healthandlongevity.reviewnexus.blog/assets/js/script.js" defer></script>
</head>
<body>
    {header}
...
Retorne APENAS o código HTML, sem explicações."""
    ...
    <div class="container">
        ...
        <p class="copyright">&copy; {ano_atual} Health and Longevity. Todos os direitos reservados.</p>
    </div>
</footer>'''
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{titulo}</title>
    <link rel="stylesheet" href="https://healthandlongevity.reviewnexus.blog/assets/css/style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <script src="https://healthandlongevity.reviewnexus.blog/assets/js/script.js" defer></script>
</head>
<body>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Health and Longevity - Reviews Honestos</title>
...
<body>
    ...
    <main class="container">
        <div style="text-align: center; padding: 60px 0;">
            <h1 style="font-size: 2.5rem; margin-bottom: 20px;">Bem-vindo ao Health and Longevity</h1>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <p class="copyright">&copy; 2025 Health and Longevity. Todos os direitos reservados.</p>
        </div>
    </footer>
</body>
</html>'''
